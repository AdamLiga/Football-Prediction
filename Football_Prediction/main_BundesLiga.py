...
# Načítanie dát
data_2014_2015 = pd.read_csv('bundes_liga_dataset/2014-2015.csv')
data_2015_2016 = pd.read_csv('bundes_liga_dataset/2015-2016.csv')
data_2016_2017 = pd.read_csv('bundes_liga_dataset/2016-2017.csv')
data_2017_2018 = pd.read_csv('bundes_liga_dataset/2017-2018.csv')
data_2018_2019 = pd.read_csv('bundes_liga_dataset/2018-2019.csv')
data_2019_2020 = pd.read_csv('bundes_liga_dataset/2019-2020.csv')
data_2020_2021 = pd.read_csv('bundes_liga_dataset/2020-2021.csv')
data_2021_2022 = pd.read_csv('bundes_liga_dataset/2021-2022.csv')

# Spojenie dát
data = pd.concat([data_2020_2021, data_2021_2022], ignore_index=True)
